...
def arguments():
	...
	parser.add_argument("--train_pt", '-t2', default=None, type = str, help="path to training images for pre-training")
	...
	parser.add_argument('--label_type', '-lt', default="PH_hist", choices=['raw','life_curve','PH_hist','persistence_image','class'], help='label type for the pretraining task')
	...
	parser.add_argument("--numof_classes_pt", '-nc2', default=148, type = int, help="num of dimensions for pretraining")
	# optimiser
